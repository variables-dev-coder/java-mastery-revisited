...
3. start fresh from current element?
...
✔ Understand currentSum

✔ Understand restart logic

✔ Can explain negative handling

✔ Can write Kadane without IDE

✔ Know O(n) optimization
